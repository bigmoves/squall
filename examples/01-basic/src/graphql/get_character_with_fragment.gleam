...
pub fn get_character_with_fragment_response_decoder() -> decode.Decoder(
  GetCharacterWithFragmentResponse,
) {
...
pub fn get_character_with_fragment_response_to_json(
  input: GetCharacterWithFragmentResponse,
) -> json.Json {
  json.object([
...
pub fn get_character_with_fragment(
...
pub fn parse_get_character_with_fragment_response(
  body: String,
) -> Result(GetCharacterWithFragmentResponse, String) {
