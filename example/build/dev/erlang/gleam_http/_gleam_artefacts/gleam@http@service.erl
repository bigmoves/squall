...
-spec map_response_body(
    fun((GSQ) -> gleam@http@response:response(GSC)),
    fun((GSC) -> GSD)
) -> fun((GSQ) -> gleam@http@response:response(GSD)).
...
-spec prepend_response_header(
    fun((GSU) -> gleam@http@response:response(GSW)),
    binary(),
    binary()
) -> fun((GSU) -> gleam@http@response:response(GSW)).
...
-spec ensure_post(gleam@http@request:request(GSH)) -> {ok,
        gleam@http@request:request(GSH)} |
    {error, nil}.
ensure_post(Req) ->
...
-spec method_override(fun((gleam@http@request:request(GUD)) -> GUL)) -> fun((gleam@http@request:request(GUD)) -> GUL).
