-module(example@graphql@get_characters).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch, inline]).
-define(FILEPATH, "src/example/graphql/get_characters.gleam").
...
-file("src/example/graphql/get_characters.gleam", 32).
...
-file("src/example/graphql/get_characters.gleam", 13).
...
-file("src/example/graphql/get_characters.gleam", 55).
...
-file("src/example/graphql/get_characters.gleam", 65).
