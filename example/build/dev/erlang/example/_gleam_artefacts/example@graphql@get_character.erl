-module(example@graphql@get_character).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch, inline]).
-define(FILEPATH, "src/example/graphql/get_character.gleam").
...
-file("src/example/graphql/get_character.gleam", 20).
...
-file("src/example/graphql/get_character.gleam", 60).
...
-file("src/example/graphql/get_character.gleam", 70).
